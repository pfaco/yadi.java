...
public class DlmsException extends Exception {
	...
	public enum DlmsExceptionReason {
		...
		ACTION_ACCESS_RESULT_SUCCESS,
		ACTION_ACCESS_RESULT_HARDWARE_FAULT,
		ACTION_ACCESS_RESULT_TEMPORARY_FAILURE,
		ACTION_ACCESS_RESULT_READ_WRITE_DENIED,
		ACTION_ACCESS_RESULT_OBJECT_UNDEFINED,
		ACTION_ACCESS_RESULT_OBJECT_CLASS_INCONSISTENT,
		ACTION_ACCESS_RESULT_OBJECT_UNAVAILABLE,
		ACTION_ACCESS_RESULT_TYPE_UNMATCHED,
		ACTION_ACCESS_RESULT_SCOPE_OF_ACCESS_VIOLATED,
		ACTION_ACCESS_RESULT_DATA_BLOCK_UNAVAILABLE,
		ACTION_ACCESS_RESULT_LONG_ACTION_ABORTED,
		ACTION_ACCESS_RESULT_NO_LONG_ACTION_IN_PROGRESS,
		ACTION_ACCESS_RESULT_OTHER_REASON,
	}
